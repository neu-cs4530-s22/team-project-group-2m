  ...
  describe('YouTube', () => {
    describe('validURL', () => {
      ...
      it('should accept a standard youtube url with youtube regular expression', () => {
        expect(validURL(VALID_STANDARD_URL, YOUTUBE_URL_PATTERN)).toBe(VALID_STANDARD_URL);
      });
      it('should accept a timestamp youtube url with youtube regular expression', () => {
        expect(validURL(VALID_START_TIME_URL, YOUTUBE_URL_PATTERN)).toBe(VALID_START_TIME_URL);
      });
      it('should accept an embed youtube url with youtube regular expression', () => {
        expect(validURL(VALID_EMBED_URL, YOUTUBE_URL_PATTERN)).toBe(VALID_EMBED_URL);
      });
      it('should accept a youtube interrupt url with youtube regular expression', () => {
        expect(validURL(VALID_YT_INTERRUPT_URL, YOUTUBE_URL_PATTERN)).toBe(VALID_YT_INTERRUPT_URL);
      });
      it('should accept a no-cookie youtube url with youtube regular expression', () => {
        expect(validURL(VALID_NO_COOKIE_URL, YOUTUBE_URL_PATTERN)).toBe(VALID_NO_COOKIE_URL);
      });
      it('should accept a long youtube url with youtube regular expression', () => {
        expect(validURL(VALID_LONG_URL, YOUTUBE_URL_PATTERN)).toBe(VALID_LONG_URL);
      });
      it('should accept a youtube short url', () => {
        expect(validURL(VALID_SHORT_URL, YOUTUBE_URL_PATTERN)).toBe(VALID_SHORT_URL);
      });
      it('should reject a non-youtube url with youtube regular expression', () => {
        expect(validURL('https://www.google.com', YOUTUBE_URL_PATTERN)).toBe(undefined);
      });
      it('should reject youtube homepage url', () => {
        expect(validURL('https://www.youtube.com/', YOUTUBE_URL_PATTERN)).toBe(undefined);
      });
      it('should reject youtube channel url', () => {
        expect(validURL('https://www.youtube.com/channel/UC-9-kyTW8ZkZNDHQJ6FgpwQ', YOUTUBE_URL_PATTERN)).toBe(undefined);
      });
      it('should reject youtube user url', () => {
        expect(validURL('https://www.youtube.com/user/TheVerge', YOUTUBE_URL_PATTERN)).toBe(undefined);
      });
      it('should reject youtube playlist url', () => {
        expect(validURL('https://www.youtube.com/playlist?list=PL634F2B56B8C346A2', YOUTUBE_URL_PATTERN)).toBe(undefined);
      });
